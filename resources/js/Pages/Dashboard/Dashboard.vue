...
const createNewTagSubmit = () =>{
    createTagModalForm.post(route('dashboard.createTag'),{
        preserveState: true,
        preserveScroll: true,
    })
}
...
function uploadPhoto(e){
    ...
    newPhotoForm.post(route('dashboard.establishment.addPhoto'), {
        preserveState: true,
        preserveScroll: true,
    });
}
...
function deletePhoto(id){
    router.delete(route('dashboard.establishment.deletePhoto', id), {
        preserveState: true,
        preserveScroll: true,
    });
}
...
const deleteTag = (id) => {
    router.delete(route('dashboard.establishment.deleteTag', {
...
const tagsAdd = () => {
    router.post(route('dashboard.establishment.addTags'), {
...
const tagsSearch = () => {
    tagSearchForm.get(route('dashboard'), {
        preserveState: true,
        preserveScroll: true,
    });
};
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <Link :href="route('dashboard.establishment.editIndex')"
